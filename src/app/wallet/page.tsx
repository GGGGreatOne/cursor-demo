...
export default function Wallet() {
  ...
  console.log('🚀 ~ file: page.tsx:9 ~ Wallet ~ res:', chainId, res.result?.[0].toString())
  const switchNetwork = useSwitchNetwork()
  const token = useToken('0x85eDB7A0cbAcf5BD641e0FF5D6270bEf9C72Bd6B', 11155111)
  console.log('🚀 ~ file: page.tsx:17 ~ Wallet ~ token:', token)
  ...
  console.log('🚀 ~ file: page.tsx:24 ~ Wallet ~ bal:', bal?.toSignificant())
  const allTransactions = useAllTransactions()
  console.log('🚀 ~ file: page.tsx:27 ~ Wallet ~ allTransactions:', allTransactions)
